...
export const siteConfig: SiteConfig = {
	...
	lang: "th", // Language code, e.g. 'en', 'zh_CN', 'ja', etc.
	themeColor: {
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/netw0rk7", // Internal links should not include the base path, as it is automatically added
